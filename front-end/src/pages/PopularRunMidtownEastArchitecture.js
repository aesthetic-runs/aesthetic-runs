...
const PopularRunMidtownEastArchitecture = () => {
  ...
  const apiIsLoaded = (map, maps) => {
    ...
    const image1 = "https://www.history.com/.image/ar_1:1%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cq_auto:good%2Cw_1200/MTY4ODE0MzA5NjU1MTkzMDkz/grand-central-terminal-gettyimages-176608565.jpg";
    const beachMarker1 = new window.google.maps.Marker({
      position: { lat: 40.753294, lng: -73.977161 },
      map,
      title: "Grand Central Terminal: Grand Central Terminal is a commuter rail terminal located at 42nd Street and Park Avenue in Midtown Manhattan, New York City.",
      icon: {
    ...
    const image2 = "https://files.ecatholic.com/6783/pictures/2022/5/19-0316-1357.jpg?t=1652113529000";
    const beachMarker2 = new window.google.maps.Marker({
      position: { lat: 40.759523, lng: -73.976239 },
      map,
      title: "St. Patrick's Cathedral: St. Patrick's Cathedral is a Catholic cathedral in the Midtown Manhattan neighborhood of New York City. It is the seat of the Archbishop of New York as well as a parish church.",
      icon: {
    ...
    const image3 = "https://www.moma.org/assets/visit/entrance-image--museum-crop-7516b01003659172f2d9dbc7a6c2e9d9.jpg";
    ...
    const image4 = "https://res.klook.com/images/fl_lossy.progressive,q_65/c_fill,w_1295,h_862/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/qvhi1a1hsxjuu0w1et61/RadioCityMusicHallStageDoorTourinNewYork.jpg";
    const beachMarker4 = new window.google.maps.Marker({
      position: { lat: 40.761248, lng: -73.980097 },
      map,
      title: "Radio City Music Hall: Radio City Music Hall is an entertainment venue and theater at 1260 Avenue of the Americas, within Rockefeller Center, in the Midtown Manhattan neighborhood of New York City. Nicknamed 'The Showplace of the Nation', it is the headquarters for the Rockettes.",
      icon: {
        size: new window.google.maps.Size(40, 30),
        scaledSize: new window.google.maps.Size(40, 30),
        url: image4
    ...
    const image5 = "https://media.tacdn.com/media/attractions-splice-spp-674x446/0c/07/df/66.jpg";
    const beachMarker5 = new window.google.maps.Marker({
      position: { lat: 40.753749, lng: -73.978702 },
      map,
      title: "Summit One Vanderbilt: SUMMIT One Vanderbilt blends elements of art, technology, architecture, and thrill to take the concept of “observation deck” to entirely new heights.",
      icon: {
        size: new window.google.maps.Size(40, 30),
        scaledSize: new window.google.maps.Size(40, 30),
        url: image5
    ...
    const image6 = "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Chrysler_building-_top.jpg/220px-Chrysler_building-_top.jpg";
    const beachMarker6 = new window.google.maps.Marker({
      position: { lat: 40.752094, lng: -73.975402 },
      map,
      title: "Chrysler Building: The Chrysler Building is an Art Deco skyscraper on the East Side of Manhattan in New York City, at the intersection of 42nd Street and Lexington Avenue in Midtown Manhattan.",
      icon: {
